...
base_path = '/home/jez/'
metum_path = f'{base_path}DSNE_ice_sheets/Jez/MetUM_Data/CORDEX_044_3Hourly/'

lsm_path = f'{base_path}DSNE_ice_sheets/Jez/MetUM_Data/CORDEX_044_Fixed/Antarctic_CORDEX_MetUM_0p44deg_lsm.nc'
out_path = f'{base_path}DSNE_ice_sheets/Jez/Bias_Correction/Data/ProcessedData/MetUM_044_Masks.nc'
